...
export default {
  ...
  async addQuestion(ctx) {
    try {
     ...
     const questionExists = exam.question.some(existingQuestion => 
       existingQuestion.question === data.question
     );
     ...
     if (questionExists) {
      ...
      const updatedQuestions = exam.question ? [...exam.question, data] : [data];
